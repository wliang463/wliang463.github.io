...
Analysis of the lunar gravity dataset reveals anomalous signal originating from subsurface Grand Canyon-sized structures. I use Markov chain Monte Carlo methods and Bayesian statistics to constrain the depth, thickness, and widths of the structures. The results filled a crucial gap in our understandings of lunar evolution.
